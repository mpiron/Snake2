...
from snake import Snake  # Tous les fichiers en minuscules, les classes avec 1 majuscule
import random  # 0.1
import pygame  # 0
pygame.init()  # 0
...
pygame.display.set_caption("Jeu Snake 4TT (version 0.6)")  # 0
...
while running:  # 0
    ...
    for event in pygame.event.get():  # 0
        ...
        # quelle touche vient d'être enfoncée
